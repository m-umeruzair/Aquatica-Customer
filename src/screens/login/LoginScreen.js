...
export const LoginScreen = ({navigation}) => {
 ...
 const showAlert3 = () =>{
  ...
  async function SignIn(e){
    e.preventDefault()
    await axios.get('http://192.168.18.133:5000/log-in',{
    params:{
        email:email,
        password:password
    }    
  ...
  return (
    <View style={styles.container}>
       ...
       <View style={styles.logoout}>
        ...
        {/* <Text style={{marginTop:10, color:colors.secondary, fontSize:20}}>Or</Text>
        <Text style={{marginTop:10, fontSize:25}}>Sign in with</Text>
        <View style={styles.social}>
            <TouchableOpacity>
                <View style={styles.socialicons}><AntDesign name="google" size={30} color={colors.primary} /></View>
            </TouchableOpacity>
            <TouchableOpacity>
                <View style={styles.socialicons}><AntDesign name="facebook-square" size={30} color={colors.primary} /></View>
            </TouchableOpacity>
        </View> */}
